...
snake_game: obj/main.o obj/Point.o obj/Object.o obj/Snake.o obj/Board.o obj/Player.o obj/win_f.o
	g++ -Wall -pedantic -std=c++11 -o snake_game obj/main.o obj/Point.o\
		obj/Object.o obj/Snake.o obj/Board.o obj/Player.o \
		obj/win_f.o -lncurses
...
obj/win_f.o: src/win_f.cpp inc/win_f.hh
	g++ ${CPPFLAGS} -o obj/win_f.o src/win_f.cpp
